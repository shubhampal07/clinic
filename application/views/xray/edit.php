      ...
      <fieldset>
        ...
        <div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="text" name='xray_name_fa' id='xray_name_fa' value="<?php echo set_value('xray_name_fa', $xray->xray_name_fa);?>" class='form-control' placeholder='  ' title='  ' required /></div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="number" name='price' id='price' value="<?php echo set_value('price', $xray->price);?>" class='form-control' placeholder='Price' title='Price' required /></div>
          </div>
