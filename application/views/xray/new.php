      ...
      <fieldset>
        ...
        <div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="text" name='xray_name_fa' id='xray_name_fa' value="<?php echo $this->input->post('xray_name_fa');?>" class='form-control' placeholder='  ' title='  ' required /></div>
          </div>
          <div class="form-group">
