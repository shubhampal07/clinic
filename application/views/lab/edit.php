      ...
      <fieldset>
        ...
        <div id="test_info">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="text" name='test_name_fa' id='test_name_fa' value="<?php echo set_value('test_name_fa', $test->test_name_fa);?>" class='form-control' required /></div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="number" name='price' id='price' value="<?php echo set_value('price', $test->price);?>" class='form-control' placeholder='Price' title='Price' required /></div>
          </div>
