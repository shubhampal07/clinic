      ...
      <fieldset>
        ...
        <div id="test_info">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="text" name='test_name_fa' id='drug_name_fa' value="<?php echo $this->input->post('test_name_fa');?>" class='form-control' placeholder=' ' title=' ' required /></div>
          </div>
          <div class="form-group">
