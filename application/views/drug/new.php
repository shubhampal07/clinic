      ...
      <fieldset>
        ...
        <div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="text" name='drug_name_fa' id='drug_name_fa' value="<?php echo $this->input->post('drug_name_fa');?>" class='form-control' placeholder='New drug' title='New drug' required /></div>
          </div>
          <div class="form-group">
