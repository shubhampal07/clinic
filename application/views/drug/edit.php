      ...
      <fieldset>
        ...
        <div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="text" name='drug_name_fa' id='drug_name_fa' value="<?php echo set_value('drug_name_fa', $drug->drug_name_fa);?>" class='form-control' placeholder='title='نquired /></div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="number" name='price' id='price' value="<?php echo set_value('price', $drug->price);?>" class='form-control' placeholder='Price' title='Price' required /></div>
          </div>
